...
export default function StoreDetailDrawer({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 flex justify-end">
      ...
      <div className="w-full max-w-lg bg-white border-l-3 border-black h-full overflow-y-auto relative z-10 shadow-2xl flex flex-col justify-between animate-fade-in-up">
        <div>
          {/* Header Image banner */}
          <div className="h-56 w-full relative bg-neutral-200 border-b-3 border-black shrink-0">
            ...
            <div className="absolute bottom-4 left-6 right-6 flex items-end justify-between bg-white border-3 border-black p-4 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
              ...
              <div className="flex items-center gap-1 bg-white border-2 border-black px-2 py-0.5 text-xs font-black text-black shrink-0">
          ...
          <div className="p-6 space-y-6">
            {/* Status indicators */}
            <div className="flex items-center justify-between p-4 bg-[#f7f6f2] border-3 border-black rounded shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]">
              ...
              {!activeStore.foodItems || activeStore.foodItems.length === 0 ? (
                ...
                <div className="space-y-4">
                  {activeStore.foodItems.map((food) => (
                    <div
                      key={food.id}
                      className="flex gap-4 p-3 bg-white border-3 border-black rounded shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[-1px] hover:translate-y-[-1px] hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all"
                    >
                      <img
                        src={
                          food.imageUrl ||
            ...
            <div className="space-y-4 pt-6 border-t-3 border-black">
              ...
              <div className="space-y-3 bg-[#f7f6f2] p-4 border-3 border-black rounded shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 py-2 bg-white text-emerald-600 border-2 border-black font-extrabold text-[10px] flex items-center justify-center gap-1.5 hover:bg-emerald-50 transition-all cursor-pointer shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-x-[1px] active:translate-y-[1px] active:shadow-[1px_1px_0px_0px_rgba(0,0,0,1)]"
                  >
                    <ThumbsUp className="w-3.5 h-3.5 fill-emerald-100" /> Ngon
                  </button>
                  <button
                    onClick={() => handleSubmitRating(activeStore.id, 'NORMAL')}
                    className="flex-1 py-2 bg-white text-neutral-600 border-2 border-black font-extrabold text-[10px] flex items-center justify-center gap-1.5 hover:bg-neutral-50 transition-all cursor-pointer shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-x-[1px] active:translate-y-[1px] active:shadow-[1px_1px_0px_0px_rgba(0,0,0,1)]"
                  >
                    <Meh className="w-3.5 h-3.5 fill-neutral-100" /> Bình Thường
                  </button>
                  <button
                    onClick={() => handleSubmitRating(activeStore.id, 'NOT_SATISFIED')}
                    className="flex-1 py-2 bg-white text-red-600 border-2 border-black font-extrabold text-[10px] flex items-center justify-center gap-1.5 hover:bg-red-50 transition-all cursor-pointer shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-x-[1px] active:translate-y-[1px] active:shadow-[1px_1px_0px_0px_rgba(0,0,0,1)]"
                  >
              ...
              <div className="space-y-3 bg-[#fff5f5] p-4 border-3 border-red-500 rounded shadow-[3px_3px_0px_0px_rgba(239,68,68,1)]">
